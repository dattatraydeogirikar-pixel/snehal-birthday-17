...
input[type="password"] { padding:8px 12px; border-radius:8px; border:1px solid #ccc; width:60%; }
button { padding:8px 16px; margin-top:10px; border-radius:8px; border:none; background-color:#ff4d88; color:white; cursor:pointer; }
.letter, .questions, .final-message { display:none; margin-top:20px; background:#fff0f6; padding:20px; border-radius:15px; }
</style>
</head>
<body>
...
updateCountdown();
document.getElementById('passwordSection').style.display='block'; // Show password now for testing
